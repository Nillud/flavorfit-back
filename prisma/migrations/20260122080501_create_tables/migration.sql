...
-- CreateIndex
CREATE UNIQUE INDEX "comments_recipe_id_key" ON "comments"("recipe_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "recipe_ingredients_recipe_id_key" ON "recipe_ingredients"("recipe_id");

-- CreateIndex
CREATE UNIQUE INDEX "recipe_ingredients_ingredient_id_key" ON "recipe_ingredients"("ingredient_id");
