/*
  ...
  - You are about to alter the column `proteins` on the `nutrition_fact` table. The data in that column could be lost. The data in that column will be cast from `DoublePrecision` to `Decimal(65,30)`.
...
*/
-- AlterTable
ALTER TABLE "nutrition_fact" ALTER COLUMN "proteins" SET DATA TYPE DECIMAL(65,30),
