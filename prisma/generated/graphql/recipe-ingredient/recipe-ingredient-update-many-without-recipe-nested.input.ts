...
export class RecipeIngredientUpdateManyWithoutRecipeNestedInput {
    ...
    set?: Array<Prisma.AtLeast<RecipeIngredientWhereUniqueInput, 'id' | 'recipeId' | 'ingredientId' | 'recipeId_ingredientId'>>;

    @Field(() => [RecipeIngredientWhereUniqueInput], {nullable:true})
    @Type(() => RecipeIngredientWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<RecipeIngredientWhereUniqueInput, 'id' | 'recipeId' | 'ingredientId' | 'recipeId_ingredientId'>>;

    @Field(() => [RecipeIngredientWhereUniqueInput], {nullable:true})
    @Type(() => RecipeIngredientWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<RecipeIngredientWhereUniqueInput, 'id' | 'recipeId' | 'ingredientId' | 'recipeId_ingredientId'>>;

    @Field(() => [RecipeIngredientWhereUniqueInput], {nullable:true})
    @Type(() => RecipeIngredientWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<RecipeIngredientWhereUniqueInput, 'id' | 'recipeId' | 'ingredientId' | 'recipeId_ingredientId'>>;
