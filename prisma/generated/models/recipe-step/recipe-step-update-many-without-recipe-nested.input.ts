...
export class RecipeStepUpdateManyWithoutRecipeNestedInput {
    ...
    set?: Array<Prisma.AtLeast<RecipeStepWhereUniqueInput, 'id' | 'recipeId'>>;

    @Field(() => [RecipeStepWhereUniqueInput], {nullable:true})
    @Type(() => RecipeStepWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<RecipeStepWhereUniqueInput, 'id' | 'recipeId'>>;

    @Field(() => [RecipeStepWhereUniqueInput], {nullable:true})
    @Type(() => RecipeStepWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<RecipeStepWhereUniqueInput, 'id' | 'recipeId'>>;

    @Field(() => [RecipeStepWhereUniqueInput], {nullable:true})
    @Type(() => RecipeStepWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<RecipeStepWhereUniqueInput, 'id' | 'recipeId'>>;
