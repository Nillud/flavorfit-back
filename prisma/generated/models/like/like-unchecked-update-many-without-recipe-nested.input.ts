...
export class LikeUncheckedUpdateManyWithoutRecipeNestedInput {
    ...
    set?: Array<Prisma.AtLeast<LikeWhereUniqueInput, 'id' | 'recipeId' | 'userId_recipeId'>>;

    @Field(() => [LikeWhereUniqueInput], {nullable:true})
    @Type(() => LikeWhereUniqueInput)
    disconnect?: Array<Prisma.AtLeast<LikeWhereUniqueInput, 'id' | 'recipeId' | 'userId_recipeId'>>;

    @Field(() => [LikeWhereUniqueInput], {nullable:true})
    @Type(() => LikeWhereUniqueInput)
    delete?: Array<Prisma.AtLeast<LikeWhereUniqueInput, 'id' | 'recipeId' | 'userId_recipeId'>>;

    @Field(() => [LikeWhereUniqueInput], {nullable:true})
    @Type(() => LikeWhereUniqueInput)
    connect?: Array<Prisma.AtLeast<LikeWhereUniqueInput, 'id' | 'recipeId' | 'userId_recipeId'>>;
